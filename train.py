...
Pipeline Steps:
  ...
  2. Extract 68 geometric features    [feature_extractor]
  3. Encode labels & split data       [model_trainer]
  4. Train Random Forest              [model_trainer]
...
def main():
    ...
    logger.info("=" * 60)
    logger.info("  ASL Sign Language — Training Pipeline Started")
    logger.info("=" * 60)
    ...
    logger.info("\n[STEP 2/6] Extracting 68-D geometric features via MediaPipe ...")
    ...
    # ── Step 4: Train Model ────────────────────────────────────────────────────
    logger.info("\n[STEP 4/6] Training Random Forest Classifier ...")
